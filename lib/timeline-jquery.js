(function ($) {
    $.fn.timeline = function (options) {
        ...
        PRIVATE.getDateBoundaries = function () {
            ...
            PRIVATE.maxDate = new Date(PRIVATE.maxDate.getFullYear() + '-12-31');
            PRIVATE.minDate = new Date(PRIVATE.minDate.getFullYear() + '-01-01');
        };
        ...
        PRIVATE.createHeader = function () {
            let startYear = PRIVATE.minDate.getFullYear();
            let endYear = PRIVATE.maxDate.getFullYear();
            let containeWidth = $(
