/*!
 * TimelineChart v0.1.2 (http://softmetrixgroup.com/timeline)
    ...
    function _updateSwimlaneItems() {
      ...
      $('.swimlane-item').each(function(){
        ...
        if($(this).hasClass('swimlane-item-single')) {
          ...
          $('.swimlane-item-range').each(function(){
      ...
      Object.keys(_classes).forEach(function(key,index) {
        ...
        if(!_classes[key].parentClass) {
          if(_classes[key].class) {
            ...
            <i class='"+_classes[key].class+"' style='font-size: "+_classes[key].width+"px'></i> \
            </div>";
          } else {
            if(_classes[key].image) {
                ...
                html += "<div class='timeline-legend-image'> \
                <i class='sfmx-triangle-right' style='font-size: "+_classes[key].height+"px; color: "+_classes[key].color+"'></i> \
                </div>";
            }
          }
